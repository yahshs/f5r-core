...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 56px hsl(var(--primary-glow) / 0.28)',
        'glow-accent': '0 0 56px hsl(var(--accent) / 0.35)',
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 26px hsl(var(--primary-glow) / 0.32)" },
          "50%": { boxShadow: "0 0 56px hsl(var(--primary-glow) / 0.55)" },
        },
        "shimmer": {
